...
public class ConsultarCategoria extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ResultSet rCat=cat.consultarCategorias(Integer.parseInt(request.getParameter("txtId")));
            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Datos Categorias</title>");            
            out.println("</head>");
            out.println("<body background =\"imagenes/biblioteca.jpg\">");
            out.println("<center><br><br><br><br><br><br><br><br><br><br>");
            out.println("<h1>Datos Categoria</h1><br>");
            if (rCat.next())
            {
                out.println("<p>TIPO: "+rCat.getString("nombreCategoria")+"</p>");
            }
            else
            {
